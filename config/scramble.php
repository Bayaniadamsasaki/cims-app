...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API documentation for the Campus Infrastructure Monitoring System (CIMS). Use this reference to integrate monitoring tools, agents, and other external systems.',
    ],
