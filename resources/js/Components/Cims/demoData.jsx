/**
 * Data contoh dashboard (`/dashboard?demo=1`). Dipakai hanya untuk menilai
 * tampilan saat inventaris masih kosong — tidak pernah dicampur dengan data
 * asli dari DashboardWebController.
 */
...
export const DEMO_DEVICES = [
    { id: 1, name: "CORE-SW-01", location: "Data Center", ip: "10.10.0.1", uptime: "182 hari", status: "online" },
    {
        id: 2,
    ...
    { id: 5, name: "RTR-BORDER-01", location: "Data Center", ip: "10.10.0.254", uptime: "365 hari", status: "online" },
    {
        id: 6,
        name: "AP-AULA-01",
