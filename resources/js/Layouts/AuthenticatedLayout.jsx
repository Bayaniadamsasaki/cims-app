...
export default function AuthenticatedLayout({ header, children }) {
    ...
    const navItems = [
        ...
        },
        {
            ...
            icon: (
                <svg
                    className="h-5 w-5 mr-3 shrink-0 text-amber-400"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                >
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar px-4 py-4">
                    <nav className="space-y-1">
                        ...
                        <div className="pt-2">
                            <button
                                onClick={() =>
                                    setShowingMasterDropdown(
                                        !showingMasterDropdown,
                                    )
                                }
                            ...
                            >
                                ...
                                <svg
                                    className={`h-4 w-4 transform transition-transform duration-150 ${showingMasterDropdown ? "rotate-180" : ""}`}
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                            ...
                            <div
                                className={`mt-1 pl-8 space-y-1 overflow-hidden transition-all duration-250 ${
                                    showingMasterDropdown
