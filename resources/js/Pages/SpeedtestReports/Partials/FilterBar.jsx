        ...
        <section className="rounded-2xl bg-brand-card border border-brand-border p-5 shadow-lg">
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                    <a
                        href={exportUrl}
                        className="inline-flex items-center gap-1.5 rounded-xl border border-brand-border bg-brand-bgSecondary px-3 py-2 text-xs font-bold text-white transition hover:border-brand-primary/50"
                    >
                    ...
                    <button
                        ...
                        className="rounded-xl px-3 py-2 text-xs font-bold text-brand-textSecondary transition hover:text-white"
                    >
                        Reset Filter
                    </button>
                </div>
