                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-slate-500">
                            Status ICMP/SNMP real-time, latensi paket, beban
                            CPU, dan kesehatan perangkat keras.
                        </p>
                    </div>
                    <button
            ...
            <div className="text-slate-900">
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 mb-8">
                    <div className="rounded-2xl bg-brand-card border border-brand-border p-6">
                        <div className="text-xs font-semibold text-brand-textSecondary uppercase tracking-wider">
                            Online Availability
                        </div>
                        <div className="flex items-baseline mt-2">
                            <span className="text-4xl font-extrabold text-brand-primary">
                                {summary.onlinePercent}%
                            </span>
                        ...
                        <div className="w-full bg-brand-bgSecondary rounded-full h-1.5 mt-4 overflow-hidden">
                            <div
                                ...
                                style={{ width: `${summary.onlinePercent}%` }}
                            ></div>
                        </div>
                    </div>
                    <div className="rounded-2xl bg-brand-card border border-brand-border p-6">
                        ...
                        <div className="flex items-baseline mt-2">
                            ...
                            <span className="text-xs text-brand-textSecondary ml-2">
                                / {summary.total} Live
                            </span>
                        </div>
                    ...
                    <div className="rounded-2xl bg-brand-card border border-brand-border p-6">
                        ...
                        <div className="flex items-baseline mt-2">
                            <span
                                className={`text-4xl font-extrabold ${summary.offline > 0 ? "text-red-700" : "text-brand-textMuted"}`}
                            >
                                {summary.offline}
                            </span>
                            <span className="text-xs text-brand-textSecondary ml-2">
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 rounded-2xl bg-brand-card border border-brand-border p-6">
                        <h3 className="text-lg font-bold text-slate-900 mb-6">
                            Device Node Telemetry
                        </h3>
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-brand-border text-left">
                                <thead>
                                    <tr>
                                        <th className="py-3 text-xs font-bold text-brand-textSecondary">
                                            Device
                                        </th>
                                        <th className="px-3 py-3 text-xs font-bold text-brand-textSecondary">
                                            Status
                                        </th>
                                        <th className="px-3 py-3 text-xs font-bold text-brand-textSecondary">
                                            Latency
                                        ...
                                        <th className="py-3 text-right text-xs font-bold text-brand-textSecondary">
                                            Logs
                                        </th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-brand-border/60">
                                    {devices.map((device) => {
                                        ...
                                        return (
                                            <tr
                                                key={device.id}
                                                className="hover:bg-brand-bgSecondary/30 transition"
                                            >
                                                <td className="whitespace-nowrap py-4 pr-3 text-sm">
                                                    <div className="font-bold text-slate-900">
                                                        {device.name}
                                                    </div>
                                                    <div className="text-xs text-brand-textSecondary font-mono mt-0.5">
                                                        {device.ip_address}
                                                    </div>
                                                </td>
                                                ...
                                                <td className="whitespace-nowrap px-3 py-4 text-sm">
                                                    ...
                                                    ram !== null ? (
                                                        <div className="flex items-center space-x-2">
                                                            <span className="text-xs font-semibold font-mono text-brand-textSecondary">
                                                                {ram}%
                                                            </span>
                                                            <div className="w-12 bg-brand-bgSecondary rounded-full h-1 overflow-hidden">
                                                                <div
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="rounded-2xl bg-brand-card border border-brand-border p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    <h3 className="text-sm font-bold text-slate-900">
                                        ISP Gateway Bandwidth
                                    </h3>
                                    <p className="text-[10px] text-brand-textSecondary">
                                        Measure actual campus gateway speeds.
                                    </p>
                                </div>
                                <button
                            ...
                            {testingSpeed ? (
                                <div className="py-8 flex flex-col items-center justify-center text-center space-y-3">
                                    ...
                                    <div className="text-xs font-semibold text-slate-900 animate-pulse">
                                        Running Speedtest...
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-brand-bgSecondary/60 border border-brand-border rounded-xl p-3 text-center">
                                            <div className="text-[10px] text-brand-textSecondary uppercase">
                                                Download
                                            </div>
                                ...
                                <div className="py-6 text-center bg-brand-bgSecondary/30 border border-brand-border/40 rounded-xl">
                                    <p className="text-xs text-brand-textSecondary">
                                        No bandwidth test run yet today.
                                    </p>
                                    <button
                                        onClick={handleRunSpeedtest}
                        ...
                        <div className="rounded-2xl bg-brand-card border border-brand-border p-6 flex flex-col">
                            <h3 className="text-sm font-bold text-slate-900 mb-1">
                                Live Alert Console
                            </h3>
                            <p className="text-[10px] text-brand-textSecondary mb-4">
                                Critical system notifications and triggers.
                            </p>
